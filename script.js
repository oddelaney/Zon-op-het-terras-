...
document.addEventListener("DOMContentLoaded", () => {
  map = L.map("map").setView([52.5, 5.3], 7);
...
function isFavoriet(name) {
  ...
  terrassen.forEach(t => {
    ...
    <div class='popup-actions'>
      <button class='fav' onclick='toggleFavoriet("${t.name}", this)'>${isFavoriet(t.name) ? "★ Verwijder" : "☆ Favoriet"}</button>
