...
function shakeHandler() {
  ...
  messageEl.classList.remove("popIn");
  void messageEl.offsetWidth;
  messageEl.classList.add("popIn");
...
document.getElementById("vibrateTestBtn").addEventListener("click", () => {
  if (navigator.vibrate) {
    navigator.vibrate([200, 50, 200]);
  } else {
    alert("Vibratie niet ondersteund op dit apparaat.");
  }
});
